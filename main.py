...
# Creating the Library table if it doesn't exist
connector.execute(
...
# Functions
def issuer_card():
    """Prompt the user for the Issuer's Card ID."""
...
def clear_and_display():
    """Clear fields and refresh the record display."""
    clear_fields()
    display_records()
...
def view_record():
    """Load selected record details into input fields for editing."""
...
def update_record():
    """Update the currently selected record in the database."""
    def update():
...
def change_availability():
    """Change the availability status of a selected book."""
...
# Setting treeview headings and columns
